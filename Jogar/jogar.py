...
# Carregamento das imagens dos objetos
"""objeto1 = pygame.image.load('objeto1.png')
objeto2 = pygame.image.load('objeto2.png')
objeto3 = pygame.image.load('objeto3.png')

objetos = [objeto1, objeto2, objeto3]  # Lista com as imagens dos objetos"""
